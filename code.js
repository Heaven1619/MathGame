...
function popup(text,button_val,button_id,top) {
  ...
  {
  popupbox.html(text);
  $('.popup_back,.popup_box').fadeIn(250);
  }
...
function popupclose () {
  $('#question').text(cur);
  $('.popup_back,.popup_box').fadeOut(500);
  clearInterval(sec_interval);
  clearInterval(ms_interval);
  sec_interval = setInterval(Timer,1000);
  ms_interval = setInterval(millisec,10);
...
function just_closepopup(){
  ...
  this_btn.parent().parent().find('.popup_back').fadeOut();
}
function next_level () {
  $('.popup_back,.popup_box').fadeOut(500);
  clearInterval(sec_interval);
...
function pause(pause_or_resume) {
  if(pause_or_resume==false)
  {
    ...
    $('body').off('click','#pause').on('click','#pause',()=>{pause(true);});
  ...
  if (pause_or_resume==true)
  {
    ...
    question.fadeOut(250,()=>{
      question.delay(500).text('آماده ؟').fadeIn(255,()=>{
        question.delay(500).fadeOut(250,()=>{
          question.delay(500).text('3').fadeIn(250,()=>{
            question.delay(500).fadeOut(250,()=>{
              question.delay(500).text('2').fadeIn(250,()=>{
                question.delay(500).fadeOut(250,()=>{
                  question.delay(500).text('1').fadeIn(250,()=>{
                    question.delay(500).fadeOut(250,()=>{
                      question.fadeIn(250).css({'fontSize':'500%'}).text(cur);
                      sec_interval = setInterval(Timer,1000);
                      ms_interval = setInterval(millisec,10);
                      $('body').on('click','#pause',()=>{pause(false);});
